...
check(k).true_pos=sum(true_pos_log)/size(ana.ROI(i).SupResParams,2);
check(k).true_neg=sum(true_neg_log)/size(ana.ROI(i).SupResParams,2);
check(k).false_pos=sum(false_pos_log)/size(ana.ROI(i).SupResParams,2);
check(k).false_neg=sum(false_neg_log)/size(ana.ROI(i).SupResParams,2);
end