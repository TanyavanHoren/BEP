function idx = function_gmm3_temp(ana, set, ROIs, i, makePlot, rej)

gm = fitgmdist([ana.ROI(i).loc.good_GMM3(:,2:3)],rej.number_gaussians); %give data, specify cluster number
