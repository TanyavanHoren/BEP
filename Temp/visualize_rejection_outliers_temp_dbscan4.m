function rejection_visualization_outliers = visualize_rejection_outliers_temp_dbscan4(ana,i, set, ROIs)

figure
scatter([ana.ROI(i).SupResParams.x_coord]',[ana.ROI(i).SupResParams.y_coord]', 1, 'r');
hold on
scatter([ana.ROI(i).loc.good_x_DBSCAN4],[ana.ROI(i).loc.good_y_DBSCAN4], 1, 'g');
