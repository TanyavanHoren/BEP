function SupResParams=rainSTORM_main(rainSTORM_env, rainSTORM_raw_stack, set)

algo_name = set.ana.loc.algo_name;
settings = set.ana.rainSTORM_settings;
...
sizeOfCCDFrame = [set.ROI.size set.ROI.size];
numberOfFrames = size(rainSTORM_raw_stack,3);
