%{
Show how the contribution of simultaneous events varies as the ratio of 
specific to non-specific events changes. 
...
------
Plot showing how the fraction of simultaneous events varies as the ratio
of specific to non-specific events changes.
