...
object_data.number = 200; %total number of objects
...
analysis_data.frames = 200; %144E3 voor volledig 2u experiment op 50ms frames
...
%generate_time_traces(intensity_data,object_data,analysis_data);
%% Determine dark and bright times from two-l   evel timetrace
intensity_data = determine_bright_dark_times(object_data, intensity_data, analysis_data);
